...
func Messages(msgs []*domain.Message) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := `My Messages`
		...
		templ_7745c5c3_Var3 := `Scroll to check out your messages.`
		...
		for _, msg := range msgs {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/components/messages.templ`, Line: 10, Col: 21}
			}
